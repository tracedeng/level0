...
#define ACCOUNTURL @"http://192.168.1.4:8000/account"
#define CONSUMERURL @"http://192.168.1.4:8000/consumer"
#define MERCHANTURL @"http://192.168.1.4:8000/merchant"
#define CREDITURL @"http://192.168.1.4:8000/credit"
#define FLOWTURL @"http://192.168.1.4:8000/flow"
#define QINIUURL @"http://7xor5x.com1.z0.glb.clouddn.com"
#define BUSINESSURL @"http://192.168.1.4:8000/business"
#define FLOWURL @"http://192.168.1.4:8000/flow"
#define DISCOUNTURL @"http://192.168.1.4:8000/activity"
#define ACTIVITYURL @"http://192.168.1.4:8000/activity"
#define VOUCHERURL @"http://192.168.1.4:8000/voucher"
#define STATISTICURL @"http://192.168.1.4:8000/maintain"
#else
